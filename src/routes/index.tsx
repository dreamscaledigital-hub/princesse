    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col items-center justify-center px-6 pb-28 pt-10">
        ...
        >
          ...
          {/* Séparateur Duel */}
          <div className="flex items-center gap-3 text-xs uppercase tracking-wide text-muted-foreground pt-2">
          ...
          <div className="rounded-2xl border border-amber-200/80 bg-amber-50/60 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="ml-auto rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-medium text-amber-600">Nouveau ⚡</span>
            </div>
            <p className="text-xs text-amber-700/70 mb-3">Annonce un gage, puis premier à taper le cœur gagne. Best of 5.</p>
            <Button
